...
// export const dynamic = "force-dynamic";//this is for dynamic render rather than noStore()
import { Suspense } from 'react';
import { CardsSkeleton, LatestInvoicesSkeleton, RevenueChartSkeleton } from '@/app/ui/skeletons';
export default async function Page() {
  // const revenue = await fetchRevenue();//deleted
  // const latestInvoices = await fetchLatestInvoices();//deleted for suspense tring
