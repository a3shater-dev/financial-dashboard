    ...
    <main className="flex min-h-screen flex-col p-6 ">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          ...
          <Image src={'/hero-desktop.png'} alt={'Screenshots of the dashboard project showing desktop version'} className={'hidden md:block'}
            width={1000} height={760} />
          <Image
            src={'/hero-mobile.png'} alt={'Mobile Image'} width={560} height={620} className={'md:hidden'} />
        </div>
      </div>
    </main>
  );
